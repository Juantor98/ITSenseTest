...
namespace Data
{
        ...
        where TEntity : class
    {
        ...
        /// </summary>
        /// <param name="routes"><c>Arreglo de string que define las propiedades e navegacion que deben ser consultadas en otras entidades por cada resgistro consultado.</c></param>
        /// <returns><c>Enumerable de datos de la entidad.</c></returns>
        public IEnumerable<TEntity> GetAll(params string[] routes)
        {
            if (routes.Count() != 0)
            {
        ...
        /// <param name="routes"><c>Arreglo de string que define las propiedades e navegacion que deben ser consultadas en otras entidades por cada resgistro consultado.</c></param>
        /// <returns><c>Enumerable de datos de la entidad.</c></returns>
        public IEnumerable<TEntity> GetAll(Expression<Func<TEntity, bool>> predicate, params string[] routes)
        {
            if (routes.Length > 0)
            {
                DbQuery<TEntity> inc = EntitySet;
        ...
        /// <param name="routes"><c>Arreglo de string que define las propiedades e navegacion que deben ser consultadas en otras entidades por cada resgistro consultado.</c></param>
        /// <returns><c>Enumerable de datos de la entidad.</c></returns>
        public TEntity Single(Expression<Func<TEntity, bool>> predicate, params string[] routes)
        {
            if (routes.Length > 0)
            {
                DbQuery<TEntity> inc = EntitySet;
